...
from src.infrastructure.repositories.sqlalchemy_user_project_history_repository import (
    SQLAlchemyUserProjectHistoryRepository,
)


async def get_user_project_history_repository(db: AsyncSession = Depends(get_db)) -> IUserProjectHistoryRepository:
    """Get the user project history repository"""
    return SQLAlchemyUserProjectHistoryRepository(db)
...
async def get_user_service(
    ...
    user_project_history_repository: IUserProjectHistoryRepository = Depends(get_user_project_history_repository),
    ...
    return UserService(
        user_repository,
        user_project_history_repository,
