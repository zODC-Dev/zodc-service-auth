...
from src.app.dependencies.common import get_nats_service, get_role_repository, get_user_repository
...
async def get_project_service(
    ...
    return ProjectService(project_repository, role_repository, user_repository, nats_service)
